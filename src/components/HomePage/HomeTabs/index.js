   ...
   <>
      ...
      {Object.keys(tabInfo).length == 0 ?""
       : <SwipeableViews
        ...
        style={{background:"white",maxWidth:"700px",opacity:"0"}}  
        className= "social-btn-5">
        {
          (tabInfo["tabHeadingInfo"].map( (heading, i) => (<SetTab key={heading.tabname} value={value} index={i} >
           <Panel imagesList={tabInfo["panelInfo"]} />
         </SetTab>)))
        }
      </SwipeableViews>}
      </div>
